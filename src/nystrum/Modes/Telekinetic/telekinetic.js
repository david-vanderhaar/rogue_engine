    ...
    return [
      ...
      (mode) => GenerateOfficeMap(mode, {
        ...
        WAVES: [
          ...
          {min: 1, max: 2, enemyKeys: ['office_0',]},
          {min: 2, max: 2, enemyKeys: ['office_1',]},
          {min: 3, max: 4, enemyKeys: ['office_0', 'office_01', 'office_2']},
        ],
      }),
      (mode) => GenerateOfficeMap(mode, {
        CHANCE_OF_CENTER_CUBICLES: 0.33,
        ...
        NUMBER_OF_EXPLOSIVES: {min: 1, max: 3},
        WAVES: [
          {min: 3, max: 6, enemyKeys: ['office_0', 'office_01', 'office_2']},
        ],
      }),
      (mode) => GenerateOfficeMap(mode, {
        CHANCE_OF_CENTER_CUBICLES: 0.33,
        ...
        NUMBER_OF_EXPLOSIVES: {min: 1, max: 3},
        WAVES: [
          {min: 5, max: 6, enemyKeys: ['office_0', 'office_1', 'office_2']},
      ...
      (mode) => GenerateParkingGarageMap(mode, {
        ...
        NUMBER_OF_EXPLOSIVES: {min: 2, max: 6},
        WAVES: [
          {min: 5, max: 8, enemyKeys: ['parking_0', 'parking_1', 'parking_2', 'drone']},
          {min: 6, max: 8, enemyKeys: ['drone']},
          {min: 5, max: 8, enemyKeys: ['parking_0', 'parking_1', 'parking_2', 'drone']},
        ],
      }),
